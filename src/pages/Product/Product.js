...
//   const CategorizedProducts = category.filter(item => item.category == categoryName);

//   console.log("category_name ", categoryName)

//   const addToWishlist = async (product) => {
//     console.log("product", product)
//     // check if product already added in wishlist
...
//               <button onClick={() => user ? addToWishlist(item) : navigate('/login', {state: { from: location } })}><FavoriteBorderOutlinedIcon className="heart-icon" /></button>
...
//             <div className="product__info">
//               <h3>{item.title}</h3>
//               <h3 className="product__description">Description: {item.description}</h3>
//               <h3 className="colour">Colour: {item.colour}</h3>
//               <h3 className="fabric">Fabric: {item.fabric}</h3>
//               {/* <h3 className="size">Available Size: {item.size}</h3> */}
...
const Product = ({ user }) => {
  ...
  return (
    <>
     ...
     <button onClick={sortByPriceHandler}>
